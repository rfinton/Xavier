    ...
    setTimeout(function() {
      ...
      if(typeof(window.orientation) != 'undefined' || navigator.userAgent.search(/iemobile/i) != -1) {
        ...
        requestAnimationFrame(function() {
          ...
          $('.photos-left').velocity({opacity: [1,0], translateX: [0,30]}, {delay:500, duration:1000});
          $('.photos-right').velocity({opacity: [1,0], translateX: [0,-30]}, {delay:500, duration:1000});
          $('.foreground').velocity('fadeIn', {delay:1000, duration:1500});
          $('.logo').velocity({opacity: [1,0], translateY: [-10,-60]}, {delay:2500, duration:1500});
          $('.thin-gold-line').velocity({width: [$('img.x-logo').outerWidth(),0]}, {delay:3500, duration:1000});
          $('.view-1').velocity('transition.slideUpIn', {delay:4000, duration:1500, complete: function() {
              $('.xli').velocity('transition.slideUpIn', {stagger:250});
            }
          });
          $('.cta, .xbutton').velocity({opacity: [1,0], translateY: [0,20]}, {delay:4500, duration:2500});
        });
      }
    }, 1500);
  }
